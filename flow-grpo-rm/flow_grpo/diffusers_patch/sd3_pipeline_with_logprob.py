...
def pipeline_with_logprob(
    ...
    last_latents = (latents / self.vae.config.scaling_factor) + self.vae.config.shift_factor
    last_latents = last_latents.to(dtype=self.vae.dtype)
    image = self.vae.decode(last_latents, return_dict=False)[0]
